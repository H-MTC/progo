...
public class MainServer extends JFrame{
	...
	public MainServer() {initComponents();}
	...
	private void initComponents() {
		...
		setTitle("MainServer--server application");
		addWindowListener(new WindowAdapter() {
			public void WindowsClosing(WindowEvent e) {closeThisGraph(e);}

			private void closeThisGraph(WindowEvent e) {
				// TODO Auto-generated method stub
				if(out != null) {
					try {
		...
		
		{
			...
			scrollpanel1.setViewportView(ta_show);
		}
		...
		contentpane.add(scrollpanel1, BorderLayout.SOUTH);
